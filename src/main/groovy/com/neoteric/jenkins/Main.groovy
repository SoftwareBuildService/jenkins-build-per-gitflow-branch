...
class Main {
    public static final Map<String, Map<String, Object>> opts = [
            ...
            x: [longOpt: 'job-prefix', required: true, args: 1, argName: 'jobPrefix', description: "Job Prefix, - gradle flag -DjobPrefix=<jobPrefix>"],
            ...
            m: [longOpt: 'local-feature-merge',  required: false, args: 0, argName: 'localFeautureMerge', description: "Execute a local merge into develop branch before build"]
    ]
